...
const UI = {
  ...
  'win The Beyond at level 5': "gagne L'Au-delà au niveau 5",
  'best': 'record',
  'Boosters': 'Boosters',
  ...
  'Sacrifice {cost} levels': 'Sacrifier {cost} niveaux',
  'Not enough upgrade levels owned ({owned}/{cost}).': 'Pas assez de niveaux d\'amélioration ({owned}/{cost}).',
  ...
  'THE BLANK REVEALED — something noticed you': 'LE BLANC RÉVÉLÉ — quelque chose t\'a remarqué',
...
const CONFIG = {
  ...
  'Sparks circle around you, zapping what they touch.': 'Des étincelles tournent autour de toi et électrisent tout ce qu\'elles touchent.',
  'Slime Wave': 'Vague Gluante',
  'A bouncy shockwave pushes everything back.': 'Une onde de choc rebondissante repousse tout sur son passage.',
  ...
  'Homing Wisps': 'Feux Follets Traqueurs',
  'Curious sparks that chase whatever moves.': 'Des étincelles curieuses qui pourchassent tout ce qui bouge.',
  ...
  'Piercing Stars': 'Étoiles Perforantes',
  'star pierce': 'perforation des étoiles',
  'Multi Stars': 'Multi-Étoiles',
  'stars per volley': 'étoiles par volée',
  'Split Stars': 'Étoiles Fractales',
  'shard(s) on a star\'s first hit': 'éclat(s) au premier impact d\'une étoile',
  'Chain Stars': 'Étoiles en Chaîne',
  'chain jump(s) on spent stars': 'rebond(s) en chaîne des étoiles épuisées',
  'Ricochet Stars': 'Étoiles Ricochet',
  'bounce(s) on spent stars': 'ricochet(s) des étoiles épuisées',
  'Extra Sparks': 'Étincelles Bonus',
  'orbs on your ring': 'orbes sur ton anneau',
  'Big Sparks': 'Grosses Étincelles',
  'orb hit radius': 'rayon d\'impact des orbes',
  'Wide Orbit': 'Orbite Large',
  'ring radius': 'rayon de l\'anneau',
  'Overdrive': 'Surrégime',
  'orbit rotation speed': 'vitesse de rotation de l\'orbite',
  'Twin Ring': 'Double Anneau',
  'counter-rotating inner ring of orbs': 'anneau intérieur d\'orbes tournant en sens inverse',
  'Supernova Sparks': 'Étincelles Supernova',
  'orb-kill splash damage': 'dégâts de zone à la mort d\'un orbe',
  'Big Wave': 'Grande Vague',
  'nova radius': 'rayon de la nova',
  'Big Shove': 'Grande Poussée',
  'nova knockback': 'recul de la nova',
  'Amplitude': 'Amplitude',
  'wave damage': 'dégâts de la vague',
  'Echo Wave': 'Vague en Écho',
  ...
  'leaf blades per throw': 'lames de feuille par lancer',
  ...
  'Extra Wisps': 'Feux Follets Bonus',
  'wisps per volley': 'feux follets par volée',
  'Long Life': 'Longue Vie',
  'wisp lifetime': 'durée de vie des feux follets',
  'Agile Wisps': 'Feux Follets Agiles',
  'wisp turn rate': 'vitesse de virage des feux follets',
  'Phantom Wisps': 'Feux Follets Fantômes',
  'pierce per wisp': 'perforation par feu follet',
  'Popping Wisps': 'Feux Follets Explosifs',
  'wisp death-pop splash damage': 'dégâts de zone à la mort d\'un feu follet',
  'Swarm': 'Essaim',
  'mini wisp(s) spawned on a wisp kill': 'mini feu(x) follet(s) créé(s) à la mort d\'un feu follet',
  ...
  'swipe arc': 'arc du coup de queue',
  ...
  '+5% damage': '+5% de dégâts',
  'Twitchy': 'Nerveux',
  '+4% fire rate': '+4% de cadence',
  'Lucky Eye': 'Œil Chanceux',
  '+2% crit chance': '+2% de chance de critique',
  'Mean Streak': 'Coup Vicieux',
  '+15% crit damage': '+15% de dégâts critiques',
  'Big Mochi': 'Gros Mochi',
  '+15 max HP': '+15 PV max',
  'Slippery': 'Glissant',
  '+4% move speed': '+4% de vitesse de déplacement',
  'Magnetic Charm': 'Charme Magnétique',
  '+12% gem magnet': '+12% d\'aimant à gemmes',
  'Coin Nose': 'Flair à Pièces',
  '+10% coins found': '+10% de pièces trouvées',
  ...
  'slain cells leave erasing residue': 'les cellules tuées laissent une trace effaçante',
  ...
  'the lawn is a jungle': 'la pelouse est une jungle',
  'Ant': 'Fourmi',
  'Wasp': 'Guêpe',
  'Spider': 'Araignée',
  'The Undergrowth': 'Les Sous-Bois',
  'everything here eats you': 'ici, tout te dévore',
  'Cat': 'Chat',
  'Centipede': 'Mille-Pattes',
  'Rat': 'Rat',
  'The City': 'La Ville',
  'mind the traffic': 'attention à la circulation',
